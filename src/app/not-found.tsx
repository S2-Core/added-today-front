  ...
  return (
    ...
    >
      <button
        ...
        tabIndex={-1}
        className="top-5 left-5 absolute p-2 rounded-full text-foreground hover:text-primary active:text-primary text-4xl transition-all duration-300 cursor-pointer"
      >
        <TbArrowBackUp />
      </button>
