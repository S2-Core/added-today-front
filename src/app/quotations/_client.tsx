...
const QuotationCarousel = ({
  ...
  useEffect(() => {
    if (!emblaApi || !quotations.length) return;
...
const Client = () => {
  ...
  const quotationsEntitlement = userCurrentPlan?.entitlements.find(
    ({ key }) => key === "QUOTATIONS",
  );
                ...
                >
                  ...
                  >
                    ...
                    <span title="Audiência muito específica pode aumentar o valor em até 40%">
                      Audiência muito específica pode aumentar o valor em até
                      40%
                    </span>
                  </motion.li>
                  <motion.li
