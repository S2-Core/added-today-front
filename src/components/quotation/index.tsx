...
const Quotation = ({ quotation }: IProps) => {
  ...
  return (
    <li className="shadow-xl/30 mx-auto p-4 border-1 rounded-md max-w-2xl text-foreground">
      <div className="flex flex-col gap-10">
        <div className="flex flex-col md:items-center gap-y-2 md:grid md:grid-cols-2 text-xs">
          <p
            title={`${(engagementRate * 100).toFixed(1).replace(".", ",")} %`}
            className="flex md:flex-row flex-col md:justify-start gap-x-1"
          >
            <span>
          ...
          <p
            ...
            className="flex md:flex-row flex-col md:justify-end gap-x-1"
          >
            <span>
        ...
        <article className="w-fit max-w-full text-primary text-sm text-justify break-words whitespace-pre-line">
        ...
        <div className="flex flex-col md:items-center gap-y-2 md:grid md:grid-cols-2 text-xs">
          ...
          >
            ...
            <span>{captalize(niche)}</span>
          </p>

          <p
            title={`Criado em ${formatDate(new Date(createdAt), { getHours: true, getMinutes: true })}`}
            className="flex md:flex-row flex-col md:justify-end gap-x-1 text-[11px]"
          >
            <span>
