...
const UserLine = ({ user }: IProps) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`items-center gap-4 grid grid-cols-[auto_1fr] bg-background p-3 px-4 border-2 rounded-md w-full ${createdUser ? "text-gray-5 border-l-0 rounded-l-none" : "text-foreground"} ${isSelected ? "border-primary" : "border-gray-3"}`}
      >
